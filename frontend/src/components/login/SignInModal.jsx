...
function SignInModal({ isOpen, onClose }) {
  ...
  /* Lock/unlock body scroll to match original behavior */
  useEffect(() => {
        ...
        <div className="bg-white dark:bg-surface-container rounded-2xl shadow-2xl overflow-hidden border border-gray-200 dark:border-white/10">
          <div className="p-8">
            ...
            <div className="space-y-3">
              ...
              {/* Google */}
              <button className="w-full flex items-center justify-center gap-3 px-6 py-3 border border-gray-200 dark:border-white/10 rounded-xl hover:bg-gray-50 dark:hover:bg-white/5 transition-colors font-medium">
              ...
              {showEmailForm && (
                <div className="pt-4 space-y-3" id="email-form">
                  <input
                    type="email"
                  ...
                  />
                  <button className="w-full py-3 bg-purple-600 hover:bg-purple-700 text-white font-bold rounded-xl transition-all">
                    Continue
                  </button>
                </div>
              )}
